...
L["aura_show_countdown_numbers_tips"] = "启用此选项只是表明遵循暴雪设置，如果你没有使用OmniCC, 你仍然需要打开“界面-动作条”内的\"" .. COUNTDOWN_FOR_COOLDOWNS_TEXT .. "\"选项。\n\n|cffff0000如果光环框体过小，则OmniCC不会显示冷却数字。\n你需要调整光环大小或调整OmniCC的“显示文字的最小字体”选项来达到预期效果，通常后者更有用|r"
L["aura_quick_block_tips"] = "|cffffffffAlt+鼠标右键添加到光环黑名单|r"
L["aura_quick_enlarge_debuff_tips"] = "|cff7CFC00Ctrl+鼠标左键添加到重点减益名单|r"
